...
class HttpCustomLoggingInterceptor(private val logger: Logger = Logger.DEFAULT) : Interceptor {
...
interface Logger {
    ...
    fun log(level: HttpCustomLoggingInterceptor.Level, message: String)

    companion object {
        /** A [Logger] defaults output appropriate for the current platform.  */
        val DEFAULT: Logger = object : Logger {
            override fun log(level: HttpCustomLoggingInterceptor.Level, message: String) =
                log(message)
